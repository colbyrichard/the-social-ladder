  ...
  return (
    <section id="services" className="border-b border-line py-24">
      <div className="mx-auto max-w-7xl px-6">
        <span className="font-mono text-xs uppercase tracking-widest text-accent">Capabilities</span>
        ...
        <div className="bento-services mt-10">
          <div className="cell-a relative flex flex-col justify-between overflow-hidden bg-surface p-8">
            ...
            <div className="relative">
              <h3 className="font-display text-2xl font-semibold text-ink">Social strategy &amp; content systems</h3>
          ...
          <div className="cell-b flex flex-col justify-between bg-gradient-to-br from-accent to-accent-dim p-6">
            ...
            <div>
              <h3 className="font-display text-lg font-semibold text-accent-ink">Paid social</h3>
          ...
          <div className="cell-c flex flex-col justify-between bg-surface p-6">
            ...
            <div>
              <h3 className="font-display text-lg font-semibold text-ink">Creator &amp; UGC</h3>
          ...
          <div className="cell-d flex flex-col justify-between bg-surface p-6">
            ...
            <div>
              <h3 className="font-display text-lg font-semibold text-ink">Analytics &amp; reporting</h3>
              <p className="mt-1.5 text-sm leading-relaxed text-ink-muted">
